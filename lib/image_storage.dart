...
void main() async {
  ...
  final FirebaseStorage storage =
      new FirebaseStorage(app: app, storageBucket: 'gs://flutter-firebase-plugins.appspot.com');
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<Null> _uploadFile() async {
    ...
    final StorageReference ref = widget.storage.ref().child('text').child('foo$rand.txt');
